 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__E80C950B_4596EC_4542AD_45BE9D_456F202E4C9181;
...
public class TokenizerResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_E80C950B-96EC-42AD-BE9D-6F202E4C9181", "Tokenizer");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_E80C950B-96EC-42AD-BE9D-6F202E4C9181", "Tokenizer", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Tokenizer") + ".dmn_nologic")));
    }
